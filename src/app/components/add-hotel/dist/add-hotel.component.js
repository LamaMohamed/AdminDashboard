...
var AddHotelComponent = /** @class */ (function () {
    // checkedStyles:any = [];
    function AddHotelComponent(fb, router, ngZone, hotelApi, hotelCategoryApi, https) {
        var _this = this;
        this.fb = fb;
        this.router = router;
        this.ngZone = ngZone;
    ...
    AddHotelComponent.prototype.submitHotelForm = function () {
        ...
        this.https.post('http://localhost:8008/api/add-hotel', formData).subscribe(function (res) {
        ...
        if (this.hotelForm) { /*  */
            ...
            // });
            this.hotelApi.AddHotel(this.hotelForm.value.name, this.hotelForm.value.style, this.hotelForm.value.deals, this.hotelForm.value.amenities, this.hotelForm.value.rooms, this.hotelForm.value.map, this.hotelForm.value["class"], this.hotelForm.value.Pricedeals, this.hotelForm.value.popular, this.hotelForm.value.langaugeSpoken);
